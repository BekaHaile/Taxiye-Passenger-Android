...
public class AboutActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textViewRateUs = (TextView) findViewById(R.id.textViewRateUs); textViewRateUs.setTypeface(Data.latoRegular(this));
		textViewLikeUs = (TextView) findViewById(R.id.textViewLikeUs); textViewLikeUs.setTypeface(Data.latoRegular(this));
		textViewTNC = (TextView) findViewById(R.id.textViewTNC); textViewTNC.setTypeface(Data.latoRegular(this));
		textViewPrivacy = (TextView) findViewById(R.id.textViewPrivacy); textViewPrivacy.setTypeface(Data.latoRegular(this));
