...
public class FreshOrderHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewholder, int position) {
        try {
            if(viewholder instanceof ViewHolder) {
                ...
                if(AppConstant.ApplicationType.FRESH == orderHistory.getStoreId())
                    holder.imageViewType.setImageResource(R.drawable.fatafat_icon_small);
                else if(AppConstant.ApplicationType.MEALS == orderHistory.getStoreId())
                    holder.imageViewType.setImageResource(R.drawable.meal_icon_small);
                else
                ...
                holder.textViewAmount.setText(String.format(activity.getResources()
                        ...
                        Utils.getMoneyDecimalFormat().format(orderHistory.getOrderAmount() + orderHistory.getJugnooDeducted())));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View convertView, Activity context) {
            ...
            imageViewType = (ImageView) convertView.findViewById(R.id.imageViewType);
