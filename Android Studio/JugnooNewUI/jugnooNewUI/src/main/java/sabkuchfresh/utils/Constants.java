...
public interface Constants {
	...
	String FB_LINK_SHARE_NAME = "Fatafat";
//	String BRANCH_END_LINK = "https://get.jugnoo.in/#/register";


	String DOMAIN_SHARE_JUGNOO_IN = "share.lofatafat.com";
	...
	String KEY_DEEP_INDEX = "deep_index";
    ...
    String KEY_SHOW_DIALOG = "KEY_SHOW_DIALOG";
    String KEY_PICTURE = "KEY_PICTURE";
    String KEY_IMAGE = "KEY_IMAGE";
    String KEY_BUTTON_TEXT = "KEY_BUTTON_TEXT";
    String SP_PUSH_DIALOG_CONTENT = "SP_PUSH_DIALOG_CONTENT";
