...
public class AddPaytmFragment extends Fragment {
	...
	public void onResume() {
		super.onResume();
		HomeUtil.checkForAccessTokenChange(getActivity());
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		buttonRequestOTP.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
                FlurryEventLogger.event(FlurryEventNames.PAYMENT_SCREEN, FlurryEventNames.REQUEST_OTP_PAYTM, FlurryEventNames.REQUEST_OTP_PAYTM);
				generateOTP(false);
			}
		});
...
//		}));
	...
	public void performBackPressed() {
		...
		if(AddPaymentPath.ADD_PAYTM.getOrdinal() == paymentActivity.addPaymentPathInt && paymentActivity.paymentPath != 1){
		...
		} else if(paymentActivity.paymentPath == 1) {
