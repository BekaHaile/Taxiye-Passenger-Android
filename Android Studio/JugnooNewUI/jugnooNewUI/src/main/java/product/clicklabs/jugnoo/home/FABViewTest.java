...
//                            ((HomeActivity) activity).getViewSlidingExtra().setVisibility(View.GONE);
    ...
    private void initOfferingsList(){
        ...
        listToggleModeData.put(Config.getAutosClientId(),new ToggleModeData(Config.getAutosClientId(), R.drawable.ic_car_white,R.color.theme_color,R.color.theme_color_alpha));
        listToggleModeData.put(Config.getDeliveryCustomerClientId(),new ToggleModeData(Config.getDeliveryCustomerClientId(),R.drawable.ic_delivery_customer_bike,R.color.green_delivery_customer_fab,R.color.green_delivery_customer_fab));
        listToggleModeData.put(Config.getAutosClientId(),new ToggleModeData(Config.getAutosClientId(), R.drawable.ic_car_white,R.color.theme_color,R.color.theme_color_alpha));
        listToggleModeData.put(Config.getDeliveryCustomerClientId(),new ToggleModeData(Config.getDeliveryCustomerClientId(),R.drawable.ic_delivery_customer_bike,R.color.green_delivery_customer_fab,R.color.green_delivery_customer_fab));
        ...
        listToggleModeData.put(Config.getFeedClientId(),new ToggleModeData(Config.getFeedClientId(),R.drawable.ic_delivery_customer_bike,R.color.theme_color,R.color.theme_color_alpha));
        ...
        listToggleModeData.put(Config.getDeliveryClientId(),new ToggleModeData(Config.getDeliveryClientId(),R.drawable.ic_car_white,R.color.theme_color,R.color.theme_color_alpha));
        listToggleModeData.put(Config.getDeliveryClientId(),new ToggleModeData(Config.getDeliveryClientId(),R.drawable.ic_car_white,R.color.theme_color,R.color.theme_color_alpha));
