...
public class StarSubscriptionCheckoutFragment extends Fragment implements PromoCouponsAdapter.Callback {
    ...
    private FreshCheckoutMergedFragment.CallbackPaymentOptionSelector callbackPaymentOptionSelector = new FreshCheckoutMergedFragment.CallbackPaymentOptionSelector() {
        @Override
