...
public class CancellationChargesDialog {
	...
	public Dialog showCancellationChargesDialog() {
		try {
			...
			textViewCancelRide.setTypeface(Fonts.mavenMedium(activity));
			...
			textViewContinue.setTypeface(Fonts.mavenRegular(activity));
