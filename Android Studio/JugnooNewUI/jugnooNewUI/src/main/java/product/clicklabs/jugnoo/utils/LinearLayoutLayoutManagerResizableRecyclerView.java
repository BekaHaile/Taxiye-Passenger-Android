 ...
 * the measure pass.
 */
public class LinearLayoutLayoutManagerResizableRecyclerView extends android.support.v7.widget.LinearLayoutManager {
	...
	public LinearLayoutLayoutManagerResizableRecyclerView(Context context) {
		super(context);
	}

	@SuppressWarnings("UnusedDeclaration")
	public LinearLayoutLayoutManagerResizableRecyclerView(Context context, int orientation, boolean reverseLayout) {
