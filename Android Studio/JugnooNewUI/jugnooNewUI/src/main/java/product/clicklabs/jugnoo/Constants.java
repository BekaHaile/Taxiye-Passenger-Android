...
public interface Constants {
    ...
    String RATING_TYPE_THUMBS = "0";
    String RATING_TYPE_STAR = "1";
    ...
    String KEY_POSITIVE_FEEDBACK_REASONS = "positive_feedback_reasons";
    ...
    String SP_MEALS_CUSTOMER_CART_ADDRESS = "sp_delivery_customer_cart_address";
    ...
    String KEY_SEARCH_ITEM_ID = "search_item_id";
    ...
    String KEY_ACCEPT_DISTANCE_TEXT = "accept_distance_text";
    ...
    String CORPORATE_DATA = "corporates";
