...
public class LocationInit {
    ...
    public static void showLocationAlertDialog(final Activity activity){
        ...
        if(sdkInt >= 19) {
            ...
            SingleButtonAlert.showAlertGps(activity, "Location Settings", "Location services is not enabled. Enable it from settings menu.",
                    new SingleButtonAlert.OnAlertOkClickListener() {
                        @Override
            ...
            //showLocationSettingsAlert(activity);
        }
    }
