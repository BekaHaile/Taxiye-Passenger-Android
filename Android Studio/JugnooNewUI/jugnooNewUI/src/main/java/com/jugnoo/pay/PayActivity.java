...
public class PayActivity extends BaseActivity implements FlurryEventNames, FirebaseEvents {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayoutLikeUs.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent;
                    if (Utils.appInstalledOrNot(PayActivity.this, "com.facebook.katana")) {
                        try {
                    ...
                    e.printStackTrace();
                    Utils.showToast(PayActivity.this, "Facebook app not enabled");
                    Intent intent = new Intent(Intent.ACTION_VIEW);
                    intent.setData(Uri.parse("https://www.facebook.com/" + facebookPageName));
                    startActivity(intent);
                }
        ...
        relativeLayoutTNC.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(PayActivity.this, HelpParticularActivity.class));
