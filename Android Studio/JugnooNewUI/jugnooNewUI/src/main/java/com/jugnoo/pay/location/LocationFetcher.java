...
//			}
    ...
    private synchronized double getSavedLatFromSP() {
        SharedPreferences preferences = context.getSharedPreferences(LOCATION_SP, 0);
        String latitude = preferences.getString(LOCATION_LAT, "" + 0.0);
    ...
    private synchronized double getSavedLngFromSP() {
        SharedPreferences preferences = context.getSharedPreferences(LOCATION_SP, 0);
        String longitude = preferences.getString(LOCATION_LNG, "" + 0.0);
...
//    public double getFTimeLatitude(){
//        try{
//            Location loc = getLoc();
//            if(loc != null){
//                return loc.getLatitude();
