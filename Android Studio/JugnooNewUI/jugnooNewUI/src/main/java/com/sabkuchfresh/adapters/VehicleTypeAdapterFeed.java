...
public class VehicleTypeAdapterFeed extends RecyclerView.Adapter<VehicleTypeAdapterFeed.ViewHolder> {

    private FreshActivity activity;
    private List<VehicleInfo> mVehiclesList;
    private boolean[] mSelectionArray;
    private int currentSelection = -1;
    private OnItemSelectedListener onClick;

    public VehicleTypeAdapterFeed(FreshActivity activity, List<VehicleInfo> mVehiclesList, int currentSelection , final OnItemSelectedListener onClick ){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ASSL.DoMagic(v);
        return new VehicleTypeAdapterFeed.ViewHolder(v, activity);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        if (h instanceof VehicleTypeAdapterFeed.ViewHolder) {
            VehicleTypeAdapterFeed.ViewHolder holder = h;
...
//            }
    ...
    public interface OnItemSelectedListener {
        ...
        void onItemSelected(VehicleInfo item, int pos);
    }
