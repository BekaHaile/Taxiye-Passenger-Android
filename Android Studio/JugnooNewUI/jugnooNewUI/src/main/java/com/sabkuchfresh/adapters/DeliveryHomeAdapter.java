    ...
    private void setHolderMethod(ViewOrderStatus statusHolder, RecentOrder recentOrder) {
        ...
        if (recentOrder.isDeliveryNotDone() ||
            ...
            if (recentOrder.isDeliveryNotDone() && recentOrder.getDeliveryConfirmation() < 0) {
                ...
                statusHolder.tvOrderDeliveredYes.setText(activity.getString(R.string.yes).toUpperCase());
                statusHolder.tvOrderDeliveredYes.setTextSize(14);
                statusHolder.tvOrderDeliveredNo.setText(activity.getString(R.string.no).toUpperCase());
                statusHolder.tvOrderDeliveredNo.setTextSize(14);
                ...
                statusHolder.tvOrderDeliveredYes.setText(Data.isFuguChatEnabled() ? R.string.chat_with_us : R.string.report_issue);
                statusHolder.tvOrderDeliveredYes.setTextSize(12);
                statusHolder.tvOrderDeliveredNo.setText(R.string.call_restaurant);
                statusHolder.tvOrderDeliveredNo.setTextSize(12);
...
//        TextView textViewAddressLine;
        ...
        private ViewHolderVendor(final View itemView, final ItemListener itemListener) {
            ...
            textViewRestaurantName.setTypeface(textViewRestaurantName.getTypeface(), Typeface.BOLD);
...
//            textViewAddressLine = (TextView) itemView.findViewById(R.id.textViewAddressLine);
            ...
            tvReviewCount.setTypeface(tvReviewCount.getTypeface(), Typeface.BOLD);
            tvOffer = (TextView) itemView.findViewById(R.id.tv_offer);
            tvOffer.setTypeface(tvOffer.getTypeface(), Typeface.BOLD);
        }
    }
    ...
    private class ViewHolderVendorDirectSearch extends RecyclerView.ViewHolder {
        ...
        private TextView tvLine1, tvLine2Start, tvLine2End;
        ...
        public ViewHolderVendorDirectSearch(final View itemView, final ItemListener itemListener) {
            ...
            tvLine1.setTypeface(tvLine1.getTypeface(), Typeface.BOLD);
