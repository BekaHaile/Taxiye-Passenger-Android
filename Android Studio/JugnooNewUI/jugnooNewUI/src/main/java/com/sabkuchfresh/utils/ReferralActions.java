        ...
        builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (info.activityInfo.packageName.contains("com.facebook.katana")) {
                    ...
                    FlurryEventLogger.event(REFER_SCREEN, "invite friends pop up others", "Facebook");
                }
                    ...
                    activity.startActivity(intent);
                    FlurryEventLogger.event(REFER_SCREEN, "invite friends pop up others", "Gmail");
                }
                    ...
                    intent.putExtra(Intent.EXTRA_TEXT, body);
                    activity.startActivity(intent);
                    FlurryEventLogger.event(REFER_SCREEN, "invite friends pop up others", "WhatsApp");
                }
				else {
                    Intent intent = new Intent(android.content.Intent.ACTION_SEND);
                    intent.setClassName(info.activityInfo.packageName, info.activityInfo.name);
