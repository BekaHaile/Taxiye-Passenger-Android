...
public class RoundedCornersTransformationGlide implements Transformation<Bitmap> {
  ...
  public RoundedCornersTransformationGlide(Context context, int radius, int margin) {
    this(context, radius, margin, CornerType.ALL);
  }

  public RoundedCornersTransformationGlide(BitmapPool pool, int radius, int margin) {
