										...
										try {
											...
											if (positionNearNew > positionNearCurr) {
												...
												LatLng pointer = list.get(positionNearCurr),
														...
														dest = list.get(positionNearNew-1);
												...
												//if displacement less than lower bound dont animate
												...
												else if(displacement > MarkerAnimation.MAX_DISTANCE || distanceToAnimate > displacement * MarkerAnimation.MAX_DISTANCE_FACTOR_GAPI){
													latLngsAnimateDriver.clear();
													latLngsAnimateDriver.add(source);
