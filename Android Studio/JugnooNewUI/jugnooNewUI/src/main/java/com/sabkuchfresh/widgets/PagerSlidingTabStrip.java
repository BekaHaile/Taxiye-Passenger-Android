...
//    private int indicatorColor = 0xEEFFFFFF;//F9BC14
    ...
    private int indicatorColor = getResources().getColor(R.color.theme_color);//F9BC14
...
//    private int tabTextColor = 0xffff8162;
	private int tabTextColorUnSelected = 0x000000;
...
//		tabTextColor = a.getColor(1, tabTextColor);
	...
	private void addTab(final int position, View tab) {
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                mMyTabClickListener.onTabClicked(position);
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < tabCount - 1; i++) {
			...
			View textView = tab.findViewById(R.id.textView);
		...
		try {
			View tab = tabsContainer.getChildAt(tabCount - 1);
			View textView = tab.findViewById(R.id.textView);
			if (textView instanceof TextView) {
