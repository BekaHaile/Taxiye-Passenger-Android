...
public class AndroidDetails implements Parcelable {
    ...
    public AndroidDetails() {
    }

    protected AndroidDetails(Parcel in) {
    ...
    public static final Parcelable.Creator<AndroidDetails> CREATOR = new Parcelable.Creator<AndroidDetails>() {
        @Override
        public AndroidDetails createFromParcel(Parcel source) {
            return new AndroidDetails(source);
        }

        @Override
        public AndroidDetails[] newArray(int size) {
            return new AndroidDetails[size];
        }
    };
}
