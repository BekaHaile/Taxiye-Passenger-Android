package com.fugu.utils.zoomview;
...
public class ZoomageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        zoomable = values.getBoolean(R.styleable.HippoZoomageView_zoomage_zoomable, true);
        translatable = values.getBoolean(R.styleable.HippoZoomageView_zoomage_translatable, true);
        animateOnReset = values.getBoolean(R.styleable.HippoZoomageView_zoomage_animateOnReset, true);
        autoCenter = values.getBoolean(R.styleable.HippoZoomageView_zoomage_autoCenter, true);
        restrictBounds = values.getBoolean(R.styleable.HippoZoomageView_zoomage_restrictBounds, false);
        doubleTapToZoom = values.getBoolean(R.styleable.HippoZoomageView_zoomage_doubleTapToZoom, true);
        minScale = values.getFloat(R.styleable.HippoZoomageView_zoomage_minScale, MIN_SCALE);
        maxScale = values.getFloat(R.styleable.HippoZoomageView_zoomage_maxScale, MAX_SCALE);
        doubleTapToZoomScaleFactor = values.getFloat(R.styleable.HippoZoomageView_zoomage_doubleTapToZoomScaleFactor, 3);
        autoResetMode = AutoResetMode.Parser.fromInt(values.getInt(R.styleable.HippoZoomageView_zoomage_autoResetMode, AutoResetMode.UNDER));
