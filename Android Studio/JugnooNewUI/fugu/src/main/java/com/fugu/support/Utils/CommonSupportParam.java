...
public class CommonSupportParam {
    ...
    public HippoSendQueryParams getSubmitQueryParams(String categoryName, String transactionId,
        ...
        HippoSendQueryParams params = new HippoSendQueryParams(FuguConfig.getInstance().getAppKey(),
                -1l,
                transactionId,
                FuguConfig.getInstance().getUserData().getUserId(),
                channelName,
                tags,
                msg,
                FuguConfig.getInstance().getUserData().getEnUserId(), 1);
