...
public class HippoSupportDetailFragment extends BaseFragment implements View.OnClickListener, SupportDetailView {
    ...
    private void setConfigColor() {
        ...
        header.setTextColor(hippoColorConfig.getFuguTextColorPrimary());
        description.setTextColor(hippoColorConfig.getFuguFaqDescription());

        descriptionBox.setHintTextColor(hippoColorConfig.getFuguTypeMessageHint());
        descriptionBox.setTextColor(hippoColorConfig.getFuguTypeMessageText());

        submit.setTextColor(hippoColorConfig.getFuguActionBarText());
        callBtn.setTextColor(hippoColorConfig.getFuguActionBarText());
        chatBtn.setTextColor(hippoColorConfig.getFuguActionBarText());


        float radius = Constants.convertDpToPixel(5);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            submit.setBackground(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));
            callBtn.setBackground(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));
            chatBtn.setBackground(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));

        } else {
            submit.setBackgroundDrawable(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));
            callBtn.setBackgroundDrawable(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));
            chatBtn.setBackgroundDrawable(FuguColorConfig.makeRoundedSelector(hippoColorConfig.getFuguActionBarBg(), radius));
    ...
    public void openChat(OpenChatParams chatParams) {
        FuguConfig.getInstance().openChatByTransactionId(chatParams.getTransactionId(),
