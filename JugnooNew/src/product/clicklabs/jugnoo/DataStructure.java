...
enum PassengerScreenMode{
	P_INITIAL, P_SCHEDULE, P_ASSIGNING, P_SEARCH, P_REQUEST_FINAL, P_IN_RIDE, P_RIDE_END
}
...
class FutureSchedule {
	...
	String scheduleId, pickupAddress, pickupTime, scheduleStatusStr;
	LatLng pickupLatLng;
	int isChangeable, scheduleStatusFlag;
